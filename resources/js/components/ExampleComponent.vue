<template>
    <div class="tabs">
        <input type="radio" id="tab1" name="tab-control" checked @click="activeTab = 0">
        <input type="radio" id="tab2" name="tab-control" @click="activeTab = 1">
        <input type="radio" id="tab3" name="tab-control" @click="activeTab = 2">
        <input type="radio" id="tab4" name="tab-control" @click="activeTab = 3">
        <ul>
            <li title="Features" :class="{ 'active': activeTab === 0 }"><label for="tab1" role="button"><svg
                        viewBox="0 0 24 24">
                        <path
            ...
            <li title="Delivery Contents" :class="{ 'active': activeTab === 1 }"><label for="tab2" role="button"><svg
                        viewBox="0 0 24 24">
                        <path
            ...
            <li title="Shipping" :class="{ 'active': activeTab === 2 }"><label for="tab3" role="button"><svg
                        viewBox="0 0 24 24">
                        <path
            ...
            <li title="Returns" :class="{ 'active': activeTab === 3 }"><label for="tab4" role="button"><svg
                        viewBox="0 0 24 24">
                        <path
        ...
        <div class="content">
            <section v-show="activeTab === 0">
                <h2>Features</h2>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ea dolorem sequi, quo tempore in eum obcaecati
                atque quibusdam officiis est dolorum minima deleniti ratione molestias numquam. Voluptas voluptates
                quibusdam cum?
            </section>
...
export default {
    ...
    computed: {
        indicatorLeft() {
            return (this.activeTab * 100) / 4 + '%'; // 4 is the total number of tabs
        }
    }
};
</script>
