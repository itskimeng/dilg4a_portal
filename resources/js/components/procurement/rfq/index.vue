                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <button type="button" class="btn btn-success btn-sm" @click="openModal()">Create
                                RFQ</button>
                            <table style="width: 100%;"
                                class="table table-striped display expandable-table dataTable no-footer" role="grid">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="select-checkbox sorting_disabled" rowspan="1" colspan="1"
                                            aria-label="Quote#" style="width: 61px;"> RFQ No.</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                                            aria-label="Premium: activate to sort column ascending" style="width: 126px;">
                                            PURPOSE</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                                            aria-label="Status: activate to sort column ascending" style="width: 126px;">PR
                                            DATE</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1"
                                            aria-label="Updated at: activate to sort column ascending" style="width: 93px;">
                                            TARGET DATE</th>
                                        <th class="details-control sorting_disabled" rowspan="1" colspan="1" aria-label=""
                                            style="width: 100px;">
                                            STATUS</th>
                                        <th class="details-control sorting_disabled" rowspan="1" colspan="1" aria-label=""
                                            style="width: 4px;"> TIME
                                            ELAPSED</th>
                                        <th class="details-control sorting_disabled" rowspan="1" colspan="1" aria-label=""
                                            style="width: 4px;">
                                            CREATED BY</th>
                                ...
                                <tbody>
                                    <tr v-for="purchaseRequest in displayedItems" :key="purchaseRequest.id">
                                        ...
                                        <td>
                                            ...
                                            <div v-if="purchaseRequest.status_id == 4" class="badge badge-submitted_gss">{{
                                                purchaseRequest.status
                                            }}</div>
                                            <div v-if="purchaseRequest.status_id == 5" class="badge badge-received_gss">{{
                                                purchaseRequest.status }}
                                            </div>
                                            <div v-if="purchaseRequest.status_id == 6" class="badge badge-with-rfq">{{
                                                purchaseRequest.status }}
                                            </div>
                                            <div v-if="purchaseRequest.status_id == 7" class="badge badge-cancelled">{{
                                                purchaseRequest.status }}
                                            </div>
                                        </td>
                                        <td>5 minutes ago</td>
                                        ...
                                        <td>
                                            ...
                                            <div v-else class="template-demo d-flex justify-content-between flex-nowrap">
                                                <button type="button" class="btn btn-success btn-rounded btn-icon" title="View PR"
                                                    @click="viewPr(purchaseRequest.id, purchaseRequest.status_id, purchaseRequest.step)">
                                                    <i class="ti-eye" style="margin-left: -3px;"></i>
                                                </button>
                                                <button type="button" class="btn btn-info btn-rounded btn-icon" title="Submit to Budget">
                                                    <font-awesome-icon :icon="['fas', 'paper-plane']"
                                                        style="margin-left: -3px;" />
                                                </button>
